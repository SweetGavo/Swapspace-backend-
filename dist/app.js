...
const offerRouter_1 = __importDefault(require("./router/offerRouter"));
const invitationRouter_1 = __importDefault(require("./router/invitationRouter"));
const coRealtorRouter_1 = __importDefault(require("./router/coRealtorRouter"));
...
const propertyFormRouter_1 = __importDefault(require("./router/propertyFormRouter"));
const teamtaskRouter_1 = __importDefault(require("./router/teamtaskRouter"));
const infoRouter_1 = __importDefault(require("./router/infoRouter"));
const favouriteRouter_1 = __importDefault(require("./router/favouriteRouter"));
...
app.use('/api/v1/teams', teamRouter_1.default);
app.use('/api/v1/ratings', ratingRouter_1.default);
app.use('/api/v1/offers', offerRouter_1.default);
app.use('/api/v1/invitations', invitationRouter_1.default);
app.use('/api/v1/auth/co-realtor', coRealtorRouter_1.default);
app.use('/api/v1/tasks', taskRouter_1.default);
app.use('/api/v1/auth/admins', adminRouter_1.default);
app.use('/api/v1/properties/owner', propertyFormRouter_1.default);
app.use('/api/v1/teamtasks', teamtaskRouter_1.default);
app.use('/api/v1/meetings', infoRouter_1.default);
app.use('/api/v1/favorites', favouriteRouter_1.default);
app.use('/api/v1/feedbacks', feedbackRouter_1.default);
