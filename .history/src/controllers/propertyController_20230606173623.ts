...
const propertyController = {
  ...
  getAllProperty: async (req: Request, res: Response): Promise<Response> => {
    try {
     ...
     const {for_Rent,for_Sale,Short_let,price_Range,area_Range,payment_frequency,property_type,specification,bedroom,bathroom,pets,renovation,view} =req.query
