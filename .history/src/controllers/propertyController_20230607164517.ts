...
const propertyController = {
  ...
  getAllProperty: async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      const filters:any = {}
     const {for_Rent,for_Sale,Short_let,price_Range,area_Range,payment_frequency,property_type,specification,s,bathroom,pets,renovation,views,proximity,add} = req.query
